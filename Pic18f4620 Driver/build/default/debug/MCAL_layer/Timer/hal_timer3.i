...
# 12 "MCAL_layer/Timer/hal_timer3.h"
...
# 12 "MCAL_layer/Timer/hal_timer3.h" 2

# 1 "MCAL_layer/Timer/../mcal_std_types.h" 1
# 11 "MCAL_layer/Timer/../mcal_std_types.h"
...
# 11 "MCAL_layer/Timer/../mcal_std_types.h" 2
...
# 35 "MCAL_layer/Timer/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_low=0,
    GPIO_high
}logic_t;
...
# 14 "MCAL_layer/Timer/hal_timer3.h" 2
...
# 15 "MCAL_layer/Timer/hal_timer3.h" 2

# 1 "MCAL_layer/Timer/../interrupt/mcal_external_interrupt.h" 1
# 82 "MCAL_layer/Timer/../interrupt/mcal_external_interrupt.h"
typedef enum {
...
# 16 "MCAL_layer/Timer/hal_timer3.h" 2
# 54 "MCAL_layer/Timer/hal_timer3.h"
typedef struct {
...
# 9 "MCAL_layer/Timer/hal_timer3.c" 2
...
static __attribute__((inline)) void Timer3_Interrupt_Config(const timer3_t *_timer);
static interrupt_handler_fun TMR3_interrupt_handler = ((void*)0);
...
static __attribute__((inline)) void Timer3_Mode_Select(const timer3_t *_timer) {
    if (0 == _timer->timer3_source_mode) {
        (T3CONbits.TMR3CS=0);
    } else if (1 == _timer->timer3_source_mode) {
        (T3CONbits.TMR3CS=1);
...
# 128 "MCAL_layer/Timer/hal_timer3.c"
    (INTCONbits.GIE=1);
    (INTCONbits.PEIE=1);
