...
# 13 "MCAL_layer/Timer/hal_timer2.h" 2
...
# 14 "MCAL_layer/Timer/hal_timer2.h" 2
...
# 15 "MCAL_layer/Timer/hal_timer2.h" 2
...
# 16 "MCAL_layer/Timer/hal_timer2.h" 2
# 49 "MCAL_layer/Timer/hal_timer2.h"
typedef struct {
...
# 8 "MCAL_layer/Timer/hal_timer2.c" 2
...
static __attribute__((inline)) void Timer2_Interrupt_Config(const timer2_t *_timer);


static interrupt_handler_fun TMR2_interrupt_handler = ((void*)0);
...
# 101 "MCAL_layer/Timer/hal_timer2.c"
    (INTCONbits.GIE=1);
    (INTCONbits.PEIE=1);
