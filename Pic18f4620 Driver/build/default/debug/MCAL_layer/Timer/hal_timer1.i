...
# 14 "MCAL_layer/Timer/hal_timer1.h" 2
...
# 15 "MCAL_layer/Timer/hal_timer1.h" 2
...
# 16 "MCAL_layer/Timer/hal_timer1.h" 2
# 57 "MCAL_layer/Timer/hal_timer1.h"
typedef struct {
...
# 8 "MCAL_layer/Timer/hal_timer1.c" 2


static timer1_preload=0;
static __attribute__((inline)) void Timer1_Mode_Select(const timer1_t *_timer);


static __attribute__((inline)) void Timer1_Interrupt_Config(const timer1_t *_timer);


static interrupt_handler_fun TMR1_interrupt_handler = ((void*)0);
...
static __attribute__((inline)) void Timer1_Mode_Select(const timer1_t *_timer) {
    if (0 == _timer->timer1_source_mode) {
        (T1CONbits.TMR1CS=0);
    } else if (1 == _timer->timer1_source_mode) {
        (T1CONbits.TMR1CS=1);
...
# 129 "MCAL_layer/Timer/hal_timer1.c"
    (INTCONbits.GIE=1);
    (INTCONbits.PEIE=1);
