...
# 45 "MCAL_layer/Timer/hal_timer0.h"
typedef enum {
...
static __attribute__((inline)) void Timer0_Interrupt_Config(const timer0_t *_timer);



static interrupt_handler_fun TMR0_interrupt_handler = ((void*)0);
...
static __attribute__((inline)) void Timer0_Mode_Select(const timer0_t *_timer) {
    if (1 == _timer->timer0_source_mode) {
        (T0CONbits.T0CS=0);
    } else if (0 == _timer->timer0_source_mode) {
        (T0CONbits.T0CS=1);
...
# 174 "MCAL_layer/Timer/hal_timer0.c"
    (INTCONbits.GIE=1);
    (INTCONbits.PEIE=1);
