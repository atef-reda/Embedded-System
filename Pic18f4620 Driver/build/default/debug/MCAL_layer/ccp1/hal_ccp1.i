...
# 11 "MCAL_layer/ccp1/../std_libraries .h"
...
# 12 "MCAL_layer/ccp1/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/ccp1/../GPIO/../device_config.h" 1
# 12 "MCAL_layer/ccp1/../GPIO/hal_gpio.h" 2
# 35 "MCAL_layer/ccp1/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_low=0,
    GPIO_high
}logic_t;
...
# 9 "MCAL_layer/ccp1/hal_ccp1.c" 2
# 24 "MCAL_layer/ccp1/hal_ccp1.c"
static __attribute__((inline)) void CCP1_Interrupt_Config(const ccp_t *ccp_obj);
static interrupt_handler_fun CCP1_interrupt_handler = ((void*)0);


static __attribute__((inline)) void CCP2_Interrupt_Config(const ccp_t *ccp_obj);
static interrupt_handler_fun CCP2_interrupt_handler = ((void*)0);
...
# 101 "MCAL_layer/ccp1/hal_ccp1.c"
Std_ReturnType CCP_DeInit(const ccp_t *ccp_obj) {
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if (((void*)0) == ccp_obj) {
        ret = (Std_ReturnType)0x00;
...
# 215 "MCAL_layer/ccp1/hal_ccp1.c"
Std_ReturnType CCP1_Compare_Mode_Set_Value(const ccp_t *ccp_obj, uint16 compare_value) {
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 330 "MCAL_layer/ccp1/hal_ccp1.c"
void CCP1_ISR(void) {
    (PIR1bits.CCP1IF=0);
...
# 369 "MCAL_layer/ccp1/hal_ccp1.c"
    (INTCONbits.GIE=1);
    (INTCONbits.PEIE=1);
...
# 395 "MCAL_layer/ccp1/hal_ccp1.c"
    (INTCONbits.GIE=1);
    (INTCONbits.PEIE=1);
