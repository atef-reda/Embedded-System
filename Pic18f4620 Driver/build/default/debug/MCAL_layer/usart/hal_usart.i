...
# 35 "MCAL_layer/usart/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_low=0,
    GPIO_high
}logic_t;
...
# 11 "MCAL_layer/usart/../interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_layer/usart/../interrupt/mcal_interrupt_config.h" 1
# 13 "MCAL_layer/usart/../interrupt/mcal_interrupt_config.h"
# 1 "MCAL_layer/usart/../interrupt/mcal_interrupt_gen_cfg.h" 1
# 13 "MCAL_layer/usart/../interrupt/mcal_interrupt_config.h" 2
# 50 "MCAL_layer/usart/../interrupt/mcal_interrupt_config.h"
typedef void (*interrupt_handler_fun)(void);
typedef enum {
    interrupt_low_priority = 0,
    Interrupt_high_priority
} interrupt_priority_cfg;
# 11 "MCAL_layer/usart/../interrupt/mcal_internal_interrupt.h" 2
...
static interrupt_handler_fun ESURT_TX_interrupt_handler = ((void*)0);



static interrupt_handler_fun ESURT_RX_interrupt_handler = ((void*)0);
static interrupt_handler_fun EUSART_FramingError_interrupt_handler = ((void*)0);
static interrupt_handler_fun EUSART_OverRunError_interrupt_handler = ((void*)0);
...
static void Eusart_Baud_Rate_Calculation(const usart_t *usart)
{
    ...
    switch(usart->baudrate_gen_config) {
        case BAUDRATE_ASYN_08BIT_LOW_SPEED:
            ...
            TXSTAbits.BRGH = 0;
            BAUDCTLbits.BRG16 = 0;
            Baud_Rate_Temp=(((8000000UL/(float)usart->baudrate)/64)-1);
            break;
        case BAUDRATE_ASYN_08BIT_HIGH_SPEED:
            TXSTAbits.SYNC = 0;
            TXSTAbits.BRGH = 1;
            BAUDCTLbits.BRG16 = 0;
            Baud_Rate_Temp=(((8000000UL/(float)usart->baudrate)/16)-1);
            break;
        ...
        case BAUDRATE_ASYN_16BIT_HIGH_SPEED:
            ...
            TXSTAbits.BRGH = 1;
            BAUDCTLbits.BRG16 = 1;
            Baud_Rate_Temp=(((8000000UL/(float)usart->baudrate)/4)-1);
            break;
...
static void Eusart_Async_Tx_Init(const usart_t *usart) {
    if (1 == usart->usart_tx_cfg.usart_tx_enable) {
        TXSTAbits.TXEN = 1;


        if (1 == usart->usart_tx_cfg.usart_tx_interrupt_enable) {
            (PIE1bits.TXIE=1);
            ESURT_TX_interrupt_handler=usart->EUSART_TXDefaultInterruptHandeler;
# 180 "MCAL_layer/usart/hal_usart.c"
            (INTCONbits.GIE=1);
            (INTCONbits.PEIE=1);

        } else if (0 == usart->usart_tx_cfg.usart_tx_interrupt_enable) {
            (PIE1bits.TXIE=0);
        } else {
        ...
        if (1 == usart->usart_tx_cfg.usart_tx_9bit_enable) {
            TXSTAbits.TX9 = 1;
        } else if (0 == usart->usart_tx_cfg.usart_tx_9bit_enable) {
            TXSTAbits.TX9 = 0;
        } else {
...
static void Eusart_Async_Rx_Init(const usart_t *usart) {
    if (1 == usart->usart_rx_cfg.usart_rx_enable) {
        RCSTAbits.CREN = 1;

        if (1 == usart->usart_rx_cfg.usart_rx_interrupt_enable) {
...
# 224 "MCAL_layer/usart/hal_usart.c"
        ...
        } else if (0 == usart->usart_rx_cfg.usart_rx_interrupt_enable) {
            (PIE1bits.RCIE=0);
        } else {
        ...
        if (1 == usart->usart_rx_cfg.usart_rx_9bit_enable) {
            RCSTAbits.RX9 = 1;
        } else if (0 == usart->usart_rx_cfg.usart_rx_9bit_enable) {
            RCSTAbits.RX9 = 0;
        } else {
