...
# 82 "MCAL_layer/ADC/../interrupt/mcal_external_interrupt.h"
typedef enum {
...
static interrupt_handler_fun ADC_interrupt_handler=((void*)0);


static void __attribute__((inline)) adc_input_channel_port_configure( const adc_chanel_select_t channel);
static void __attribute__((inline)) adc_select_result_format(const adc_conf_t *_adc);
static void __attribute__((inline)) adc_confegration_referance(const adc_conf_t *_adc);
...
Std_ReturnType ADC_Get_Conversion_Result(const adc_conf_t *_adc, uint16 *conversion_result) {
    ...
    if ((((void*)0) == _adc) || ((void*)0) == conversion_result) {
        ...
        } else if (0X01 == _adc->result_format) {
...
static void __attribute__((inline)) adc_confegration_referance(const adc_conf_t *_adc) {
    if (0X01 == _adc->voltage_referance) {
        do{ADCON1bits.VCFG1=1; ADCON1bits.VCFG0=1; }while(0);
    } else if (0X00 == _adc->voltage_referance) {
