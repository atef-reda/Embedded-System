...
# 5 "D:\\applications\\xc8 complier\\pic\\include\\c99\\stdio.h" 2 3
...
# 11 "D:\\applications\\xc8 complier\\pic\\include\\c99\\stdio.h" 2 3
...
# 1 "D:\\applications\\xc8 complier\\pic\\include\\c99\\ctype.h" 1 3
# 10 "D:\\applications\\xc8 complier\\pic\\include\\c99\\ctype.h" 3
int isalnum(int);
int isalpha(int);
int isblank(int);
int iscntrl(int);
...
int tolower(int);
int toupper(int);
# 48 "D:\\applications\\xc8 complier\\pic\\include\\c99\\ctype.h" 3
# 1 "D:\\applications\\xc8 complier\\pic\\include\\c99\\bits/alltypes.h" 1 3
# 421 "D:\\applications\\xc8 complier\\pic\\include\\c99\\bits/alltypes.h" 3
typedef struct __locale_struct * locale_t;
# 49 "D:\\applications\\xc8 complier\\pic\\include\\c99\\ctype.h" 2 3
...
# 1 "D:\\applications\\xc8 complier\\pic\\include\\c99\\string.h" 1 3
# 25 "D:\\applications\\xc8 complier\\pic\\include\\c99\\string.h" 3
# 1 "D:\\applications\\xc8 complier\\pic\\include\\c99\\bits/alltypes.h" 1 3
# 26 "D:\\applications\\xc8 complier\\pic\\include\\c99\\string.h" 2 3
...
# 11 "./MCAL_layer/mcal_std_types.h"
# 1 "./MCAL_layer/std_libraries .h" 1
# 11 "./MCAL_layer/mcal_std_types.h" 2
...
# 12 "D:\\applications\\xc8 complier\\pic\\include\\c99\\xc8debug.h" 3
...
void infixToPostfix12(const char* infix, char* postfix) {
    ...
    for (i = 0; infix[i] != '\0'; i++) {
        if ((((infix[i] == ' ') || ((unsigned char)((infix[i])-'\t') < 5)))) {
            continue;
        }
        else if ((((unsigned char)((infix[i])-'0')) < 10)) {
            while ((((unsigned char)((infix[i])-'0')) < 10)) {
                postfix[j++] = infix[i++];
            }
            postfix[j++] = ' ';
            i--;
...
uint32 evaluatePostfix(const char* postfix) {
    ...
    for (i = 0; postfix[i] != '\0'; i++) {
        if ((((postfix[i] == ' ') || ((unsigned char)((postfix[i])-'\t') < 5)))) {
            continue;
        }
        else if ((((unsigned char)((postfix[i])-'0')) < 10)) {
            int num = 0;
            while ((((unsigned char)((postfix[i])-'0')) < 10)) {
